...
class ShopTest {
    ...
    public void testCreateShop() {
        ...
        ShopManager validArg5 = mock(ShopManager.class);
        List<Sandwich> validArg6 = new ArrayList<>();
        validArg6.add(mock(Sandwich.class));
        ...
        List<Sandwich> invalidArg4 = new ArrayList<>();
