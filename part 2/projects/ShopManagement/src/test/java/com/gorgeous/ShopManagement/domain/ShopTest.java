...
class ShopTest {
    ...
    public void testCreateShop() {
        ...
        ShopProperties validArg7 = mock(ShopProperties.class);

        try {
            new Shop(validArg1, validArg2, validArg3, validArg4, validArg5, validArg6, validArg7);
        } catch (Exception e) {
            fail("Should not thrown exception");
        }

        try {
            new Shop(null, validArg2, validArg3, validArg4, validArg5, validArg6, validArg7);
        ...
        try {
            new Shop(validArg1, null, validArg3, validArg4, validArg5, validArg6, validArg7);
            fail("Should have thrown exception");
        } catch (Exception e) {
            Assert.isInstanceOf(IllegalArgumentException.class, e);
        ...
        try {
            new Shop(validArg1, validArg2, null, validArg4, validArg5, validArg6, validArg7);
            fail("Should have thrown exception");
        } catch (Exception e) {
            Assert.isInstanceOf(IllegalArgumentException.class, e);
        ...
        try {
            new Shop(validArg1, validArg2, validArg3, null, validArg5, validArg6, validArg7);
            fail("Should have thrown exception");
        } catch (Exception e) {
            Assert.isInstanceOf(IllegalArgumentException.class, e);
        ...
        try {
            new Shop(validArg1, validArg2, validArg3, validArg4, null, validArg6, validArg7);
            fail("Should have thrown exception");
        } catch (Exception e) {
            Assert.isInstanceOf(IllegalArgumentException.class, e);
        ...
        try {
            new Shop(validArg1, validArg2, validArg3, validArg4, validArg5, null, validArg7);
            fail("Should have thrown exception");
        } catch (Exception e) {
            Assert.isInstanceOf(IllegalArgumentException.class, e);
        ...
        try {
            new Shop(validArg1, validArg2, validArg3, validArg4, validArg5, validArg6, null);
            fail("Should have thrown exception");
        } catch (Exception e) {
            Assert.isInstanceOf(IllegalArgumentException.class, e);
            Assert.isTrue(Objects.equals(e.getMessage(), "ShopProperties is required"), "Should have the same message");
        }

        List<DailySchedule> invalidArg1 = new ArrayList<>();

        try {
            new Shop(validArg1, validArg2, validArg3, invalidArg1, validArg5, validArg6, validArg7);
            fail("Should have thrown exception");
        } catch (Exception e) {
            Assert.isInstanceOf(IllegalArgumentException.class, e);
        ...
        try {
            new Shop(validArg1, validArg2, validArg3, invalidArg2, validArg5, validArg6, validArg7);
            fail("Should have thrown exception");
        } catch (Exception e) {
            Assert.isInstanceOf(IllegalArgumentException.class, e);
            Assert.isTrue(Objects.equals(e.getMessage(), "Must have 7 daily Schedules"), "Should have the same message");
        ...
        try {
            new Shop(validArg1, validArg2, validArg3, invalidArg3, validArg5, validArg6, validArg7);
            fail("Should have thrown exception");
        } catch (Exception e) {
            Assert.isInstanceOf(IllegalArgumentException.class, e);
        ...
        try {
            new Shop(validArg1, validArg2, validArg3, validArg4, validArg5, invalidArg4, validArg7);
            fail("Should have thrown exception");
        } catch (Exception e) {
            Assert.isInstanceOf(IllegalArgumentException.class, e);
