...
public class Shop implements Entity<Shop> {
    ...
    public Shop(final ShopInternalId id, final ShopDesignation designation, final ShopAddress address, List<DailySchedule> dailySchedules, final UserInternalId shopManagerId, List<SandwichInternalId> sandwichList) {
